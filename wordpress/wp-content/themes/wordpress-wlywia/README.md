...
$ composer create-project roots/sage your-theme-name --repository="{\"url\": \"git@github.com-skwalgit:skwalgit/sage.git\", \"type\": \"vcs\"}" --stability=dev --remove-vcs
```
...
├── app/                  # → Theme PHP
│   ├── Blocks/           # → ACF blocks field
│   ├── Fields/           # → ACF fields
│   ├── Hooks/            # → WP Hooks
│   ├── Posttypes/        # → WP Custom Post Types Register
│   ├── Providers/        # → Service providers
│   ├── View/             # → View models
│   ├── admin.php         # → Theme customizer setup
│   ├── blocks.php        # → Theme blocks setup
│   ├── filters.php       # → Theme filters
│   ├── helpers.php       # → Helper functions
│   └── setup.php         # → Theme setup
│   └── starter.php       # → Theme starter content
